    ...
    try {
      if (validateForm()) {
        ...
        const user = userCredential.user;
         ...
         router.push('/');/*routes to home page*/
         setErrors({});
      }
    } catch (error) {
  ...
  return (
    <div className="flex justify-center items-center h-screen font-primary p-10 m-2">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-2xl shadow-lg p-10">
        ...
        <h1 className='font-secondary text-xl text-center font-semibold text-[#0b3a65ff]'><img src="./logo.png" alt="Logo" className="logo-image" style={{ width: '80px', height: '80px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginLeft: '255px' }}
         />TSCZ<span className='font-bold text-[#1c6d22]'>-S4F3-</span>CHAT</h1>
        ...
        <div>
          <button type='submit' className="btn btn-block bg-[#15d361] text-white">
            {
